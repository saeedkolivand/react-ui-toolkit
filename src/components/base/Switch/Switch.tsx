...
> {
  ...
  /**
   * Ref forwarded to the underlying input. React 19 passes `ref` as a regular
   * prop, so no forwardRef wrapper is needed.
   */
  ...
  return (
    <div className="relative">
      <div className="flex items-center">
        <div className={switchClasses} role="switch" aria-checked={checked} onClick={handleChange}>
          <input
            ref={ref}
            type="checkbox"
            className="sr-only"
